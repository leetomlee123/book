...
| `lib/model/reader/` | Reader collaborators: `text_paginator`, `reader_painter`, `chapter_content_loader`, `reading_progress_store`, `page_picture_cache`, `page_picture_resolver` |
